...
if(TRUE){
  ...
  source("package_source/package_source_fabR/R/00-lazy.R")
  source("package_source/package_source_fabR/R/01-functions_template.R")
  source("package_source/package_source_fabR/R/02-file_index.R")
  source("package_source/package_source_fabR/R/03-dates.R")
  source("package_source/package_source_fabR/R/04-viz.R")
  source("package_source/package_source_fabR/R/05-check_table_values.R")
  
  source("package_source/package_source_tinyPackage/R/00-utils.R")
  source("package_source/package_source_tinyPackage/R/03-dictionaries_functions.R")
  source("package_source/package_source_tinyPackage/R/04-data_QA.R")
  source("package_source/package_source_tinyPackage/R/05-summary_functions.R")
  source("package_source/package_source_tinyPackage/R/06-visualize.R")
  source("package_source/package_source_tinyPackage/R/08-catalogue_functions.R")
  }
